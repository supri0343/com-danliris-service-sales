...
{
    public class CostCalculationByMarketingReportTest 
   {
        ...
        protected virtual Mock<IServiceProvider> GetServiceProviderMock(SalesDbContext dbContext)
        {
            ...
            CostCalculationByMarketingReportLogic costCalculationByMarketingReportLogic = new CostCalculationByMarketingReportLogic(identityService, dbContext);
            ...
            serviceProviderMock
                .Setup(x => x.GetService(typeof(CostCalculationByMarketingReportLogic)))
                .Returns(costCalculationByMarketingReportLogic);
        ...
        public async void Get_Report_Success()
        {
            ...
            ICostCalculationGarmentByMarketingReport costCalculationGarmentByMarketingReport = new CostCalculationGarmentByMarketingReportFacade(serviceProvider, dbContext);
            ...
            var Response = costCalculationGarmentByMarketingReport.Read(filter: JsonConvert.SerializeObject(filter));
        ...
        public async void Get_Excel_Success()
        {
            ...
            var Response = costCalculationGarmentByMarketingReport.GenerateExcel(filter: JsonConvert.SerializeObject(filter));
