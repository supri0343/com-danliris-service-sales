...
{
    public class NewFinishingPrintingSalesContractFacadeTest : BaseFacadeTest<SalesDbContext, FinishingPrintingSalesContractFacade, FinishingPrintingSalesContractLogic, FinishingPrintingSalesContractModel, FinisihingPrintingSalesContractDataUtil>
    {
        private const string ENTITY = "NewFinishingPrintingSalesContract";

        public NewFinishingPrintingSalesContractFacadeTest() : base(ENTITY)
        {
        }
