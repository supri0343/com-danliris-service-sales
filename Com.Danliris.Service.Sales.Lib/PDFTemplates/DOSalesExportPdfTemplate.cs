...
{
    public class DOSalesExportPdfTemplate
    {
        public MemoryStream GeneratePdfTemplate(DOSalesViewModel viewModel, int clientTimeZoneOffset)
        {
            ...
            foreach (DOSalesLocalViewModel item in viewModel.DOSalesLocalItems)
            {
                ...
                bodyCell.Phrase = new Phrase(item.ProductionOrder.FinishingPrintingSalesContract.CostCalculation.ProductionOrderNo, normal_font);
                bodyTable.AddCell(bodyCell);
